      ...
      <div className='row'>
        ...
        <div className='row' style={{display:"flex",alignItems:"center",justifyContent:'center',position:"relative",bottom:"40px"}}>
          ...
          <div className='row' style={{justifyContent:"space-evenly" ,marginTop:"20px"}}>
                ...
                <div className='col'><p><span>Event Date </span></p></div>
                <div className='col'><p><span>Fee </span></p></div>
                </div>
            {even.map((eve)=>{
                return (
                <div className='row' style={{justifyContent:"space-evenly",marginTop:"20px" , width:"100%",height:"100%",backgroundColor:"lightgray"}}>
                <div className='col'><p>{eve.ename}</p></div>
                <div className='col'><p>{eve._id}</p></div>
                <div className='col'><p>{eve.sdate}</p></div>
                <div className='col'><p>{eve.fee}</p></div>
                </div>)
            })}
          </div>
