...
// import loginadmin from '../assets/images/'
...
function LoginUser() {
    ...
    async function loginpar(e) {
        e.preventDefault();
        const data1 = {
            sap:sap,
            password: password
        }
        const res = await fetch('http://localhost:1234/loginp', {
            method: "POST",
            headers: {
    ...
    return (
        <>
        <section style= {{width: '100%', height: "100vh", backgroundColor: "#F5F5F5"}}>
        ...
        <div className="container-fluid" style={{display:"flex",justifyContent:"center",alignItems:"center", minHeight: '90vh'}}>
            <div className="container" style={{marginTop:"10%", display: "flex", flexDirection: "column", padding: "0 15px 0 15px"}}> 
                ...
                <div className="container text-center">
                    <form onSubmit={loginpar}>
                        <div class="input mb-3" style = {{display: "flex", flexDirection: "column"}}>
                            {/* <label for="exampleInputEmail1" class="form-label">Email address</label> */}
                            <input value={sap} onChange={(e) => setsap(e.target.value)} type="Number" placeholder="SAP ID" style = {{height: "45px", width: "87%", outline: "none", borderRadius: "100px", padding: "0 0 0 45px", background: "rgba(255,255,255,0.1)"}}/>
